...
use QD\readonly\ReadonlyFields;
use yii\base\Event;
...
abstract class BaseRelationField extends Field implements PreviewableFieldInterface, EagerLoadingFieldInterface
{
     ...
     */
    protected string $inputTemplate = 'readonly-fields/fieldtypes/relation/input.twig';
...
JS, [
    ...
    public function afterElementSave(ElementInterface $element, bool $isNew): void
    {
        ...
        if (
            ...
            ReadonlyFields::getInstance()->getRelationsService()->saveRelations($this, $element, $targetIds);
